        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p>At EduTrack, we believe that every student is unique, and so is their learning journey. Our personalized training programs are designed to provide one-on-one attention, customized lesson plans, and tailored study strategies to help students excel. With expert tutors who adapt to individual learning styles , we ensure a focused and result-driven approach. </p>
                <!-- <p><a href="Personalinfo.php " class="btn btn-primary px-4 rounded-0">Learn More</a></p> -->
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p>At EduTrack, we offer a meticulously curated selection of trusted courses designed to empower students with the best learning experience. Each course is crafted by experienced educators and follows a structured curriculum that ensures a deep understanding of concepts. Our trusted courses provide the perfect foundation for academic success. </p>
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Structured Work Schedules</h2>
                <p>At EduTrack, we believe that consistent practice is key to academic success. To ensure effective learning, we provide regular assignments and well-structured work schedules that help students stay on track with their studies. Our carefully designed tasks reinforce classroom concepts, encourage critical thinking, and promote self-discipline. 
                <!-- <p><a href="#" class="btn btn-primary px-4 rounded-0">Learn More</a></p> -->
              </div>
            </div> 
          </div>
              ...
              <div class="owl-slide-3 owl-carousel">
                  <div class="course-1-item">
                    ...
                    <div class="course-1-content pb-4">
                      <h2> Intensive preparation for NEET</h2>
